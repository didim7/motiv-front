import { products512 } from "@/data/products/fashion";
...
export default function Shop1_2() {
  ...
  const [filtered, setFiltered] = useState(products512);
  useEffect(() => {
    if (currentCategory == "All") {
      setFiltered(products512);
    } else {
      setFiltered(
        products512.filter((elm) => elm.filterCategory2 == currentCategory)
      );
    }
  }, [currentCategory]);
        ...
        >
          <div className="shop-banner position-relative">
            ...
            >
              <img
                loading="lazy"
                src="/assets/images/shop/cover2.jpeg"
                width="1759"
                height="420"
                alt="Pattern"
